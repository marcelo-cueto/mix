...
<head>
    ...
    <title>Enlace Profesional - Home</title>
                ...
                <div class="container box_1620">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav justify-content-end">
                            <li class="nav-item active"><a class="nav-link" href="home_web.php">Home</a></li>
                            <li class="nav-item"><a class="nav-link" href="home_web.php">Nosotros</a></li>
                            <li class="nav-item"><a class="nav-link" href="home_web.php">Noticias</a>
